...
- Presented the logs of the simulation in a default summarised way, as well as a more verbose one depending on user input.
...
- Initial explanation of the protocol was hard to understand, due to the limited literature available. After more careful reading and discussion with the supervisor, managed to get a good graps of the logic.
...
**Deliverable:** Implementation of terraform code for automated setting up of the environment, test that deployments are successiful from GitHub.

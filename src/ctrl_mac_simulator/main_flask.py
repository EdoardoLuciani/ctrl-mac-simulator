import simpy, random, logging, argparse, random, sys, pathlib, io
...
def simulate():
    ...
    gateway = Gateway(
        env, args['data_channels'], args['data_slots_per_channel'], args['request_slots'], args['rrm_period'], args['max_cycles'], global_logger_memory_handler, logging_level, stat_tracker
    )
    sensors = [
        Sensor(
            env,
